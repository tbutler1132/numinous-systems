...
- Why the synthetic layer is constitutive (part of what we are) rather than instrumental (tools we use)
- No pure baseline exists—the hybrid is what we have
...
This artifact is in development. The argument structure is refined; the unified essay is not yet written.
