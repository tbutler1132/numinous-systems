...
- What is the purpose of existence? (Beauty Redeems)
- What must be preserved for that purpose to matter? (The Living System)
...
| 2   | **The Living System** | The subject — what must be preserved to experience  |
...
Every other category serves this one:

- **Essays** develop specific arguments implied here
- **Aesthetic** gives sensory form to the abstractions
- **Songs** are concrete expressions of the worldview
- **Story** narrates the lived experience of these ideas
- **Apps** enable engagement with them
- **Sensors** provide the memory to act on them
- **Reference** offers guardrails to check against
